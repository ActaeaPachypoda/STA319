...
##drillRock <-source_data(url = "https://raw.github.com/ActaeaPachypoda/STA319/blob/master/Data/drillrock.csv",sep = ",", header = TRUE)
#setwd('E:/School/2019/Spring/319 - Applied Statistics/STA319')
drillRock <- read.csv(file = "G:/School/2019/Spring/319 - Applied Statistics/STA319/Data/drillrock.csv",header = TRUE)
```
